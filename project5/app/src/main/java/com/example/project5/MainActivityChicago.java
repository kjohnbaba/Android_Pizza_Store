...
/**
 * The MainActivityChicago class is where pizzas are being made and orders are being sent to the
...
public class MainActivityChicago extends AppCompatActivity {
    ...
    static PizzaFactory pizzaFactory = new ChicagoPizza();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activitymainchicago);
        pizzaType = getIntent().getStringExtra("Pizza_Type");
        pizzaChoice = getIntent().getStringExtra("Pizza_Choice");
        pizza_option = (TextView) findViewById(R.id.pizza_option);
        pizza_price = (TextView) findViewById(R.id.price);
        pizza_crust = (TextView)findViewById(R.id.crust);
        pizza_option.setText(pizzaChoice);
        toppings_view = (ListView) findViewById(R.id.toppings_view);
        pizza_image = (ImageView) findViewById(R.id.pizza_image);
        selectToppings = (Button) findViewById(R.id.button6);
        if(!pizzaChoice.equals("Build Your Own")){
            selectToppings.setVisibility(View.INVISIBLE);
        }
        add_order1 = findViewById(R.id.add_order);
    ...
    private void setAddButtonOnClick() {
        add_order1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder alert = new AlertDialog.Builder(MainActivityChicago.this);
                ...
                alert.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(MainActivityChicago.this, "Pizza added.", Toast.LENGTH_LONG).show();
                    }
                }).setNegativeButton("no", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Toast.makeText(MainActivityChicago.this, "Pizza not added.", Toast.LENGTH_LONG).show();
                    }
                });
    ...
    public void setScene(String pizzaChoice){
        if(pizzaChoice.equals("Meatzza")){
            ...
            pizza_crust.setText("Crust: Stuffed");
            pizza_image.setImageResource(R.drawable.deepdishmeatzza);
        }
        if(pizzaChoice.equals("BBQ Chicken")){
            toppings = new ArrayList<String>(Arrays.asList("BBQ Chicken", "Green Pepper", "Provolone", "Cheddar"));
            arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, toppings);
            toppings_view.setAdapter(arrayAdapter);
            pizza_crust.setText("Crust: Pan");
            pizza_image.setImageResource(R.drawable.deepdishbbq);
        }
        if(pizzaChoice.equals("Build Your Own")){
            ...
            toppings_view.setAdapter(arrayAdapter);
            pizza_crust.setText("Crust: Pan");
            pizza_image.setImageResource(R.drawable.buildurowndeepdish);
        }
        if(pizzaChoice.equals("Deluxe")){
            toppings = new ArrayList<String>(Arrays.asList("Sausage", "Pepperoni", "Green Pepper", "Onion", "Mushroom"));
            arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, toppings);
            toppings_view.setAdapter(arrayAdapter);
            pizza_crust.setText("Crust: Deep Dish");
            pizza_image.setImageResource(R.drawable.deluxechicago);
        }
    }
    ...
    public void callToppings(){
        selectToppings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityChicago.this, ToppingActivity.class);
                intent.putExtra("type", "Chicago");
